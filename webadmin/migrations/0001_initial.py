...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Respuesta',
            fields=[
                ('id_usuario', models.OneToOneField(db_column='id_usuario', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='webadmin.Usuario')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_usuario', models.OneToOneField(db_column='id_usuario', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='webadmin.Usuario')),
                ('id_articulo', models.ForeignKey(db_column='id_articulo', on_delete=django.db.models.deletion.DO_NOTHING, to='webadmin.Articulo')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='id_pregunta',
            field=models.ForeignKey(db_column='id_pregunta', on_delete=django.db.models.deletion.DO_NOTHING, to='webadmin.Pregunta'),
        ),
